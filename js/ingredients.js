...
const INGREDIENTS = [
  ...
  // --- mushroom ---
  { id: "shimeji", name: "しめじ", emoji: "🍄", category: "mushroom", qty: "1/2株", tags: ["sugar", "immune"],
    nutrients: [
      { name: "β-グルカン", effect: "糖質の吸収スピードを緩やかにし、食後血糖値の急上昇を抑える働きがあるとされています。" },
      { name: "ビタミンD", effect: "カルシウムの吸収を助けます。" },
    ] },
  { id: "enoki", name: "えのき", emoji: "🍄", category: "mushroom", qty: "1/2袋", tags: ["gut"],
    nutrients: [
      { name: "食物繊維", effect: "腸内の善玉菌のエサになり、便通をサポートします。" },
      { name: "ナイアシン", effect: "エネルギー代謝を助けるビタミンです。" },
    ] },
  { id: "maitake", name: "まいたけ", emoji: "🍄", category: "mushroom", qty: "1/2パック", tags: ["immune", "bone"],
    nutrients: [
      { name: "β-グルカン", effect: "免疫の働きをサポートするとされる食物繊維です。" },
      { name: "ビタミンD", effect: "骨の健康に関わる栄養素です。" },
    ] },
  { id: "shiitake", name: "しいたけ", emoji: "🍄", category: "mushroom", qty: "2枚", tags: ["gut"],
    nutrients: [
  ...
  // --- seaweed ---
  { id: "wakame", name: "わかめ", emoji: "🌊", category: "seaweed", qty: "大さじ1(乾燥)", tags: ["bone", "gut"],
    nutrients: [
      { name: "カルシウム・ヨウ素", effect: "骨の健康や、代謝に関わる甲状腺ホルモンの材料になります。" },
      { name: "水溶性食物繊維", effect: "腸内環境を整える働きがあります。" },
    ] },
  { id: "hijiki", name: "ひじき", emoji: "🌊", category: "seaweed", qty: "10g(乾燥)", tags: ["bone", "gut"],
    nutrients: [
      { name: "鉄分・カルシウム", effect: "貧血予防や骨密度の維持に役立つとされています。" },
      { name: "食物繊維", effect: "便のかさを増やし、便通を整える助けになります。" },
    ] },
  { id: "nori", name: "焼きのり", emoji: "🍙", category: "seaweed", qty: "1枚", tags: ["immune", "skin"],
    nutrients: [
  ...
  // --- bean ---
  { id: "soybean", name: "蒸し大豆", emoji: "🫘", category: "bean", qty: "50g", tags: ["bone", "diet"],
    nutrients: [
      { name: "大豆たんぱく質", effect: "骨を作るコラーゲンの材料にもなる良質なたんぱく質です。" },
      { name: "イソフラボン", effect: "骨からのカルシウム流出を抑える働きが期待されています。" },
    ] },
  { id: "chickpea", name: "ひよこ豆", emoji: "🫘", category: "bean", qty: "50g(水煮)", tags: ["gut", "diet"],
    nutrients: [
      { name: "食物繊維", effect: "腸内環境を整え、満腹感の持続にも役立ちます。" },
      { name: "植物性たんぱく質", effect: "低脂質にたんぱく質を補給できます。" },
    ] },
  { id: "edamame", name: "枝豆", emoji: "🫛", category: "bean", qty: "50g(さやなし)", tags: ["fatigue"],
    nutrients: [
      { name: "ビタミンB1", effect: "糖質の代謝を助け、疲労回復をサポートします。" },
      { name: "大豆たんぱく質", effect: "体づくりに役立つ良質なたんぱく質です。" },
    ] },
  { id: "atsuage", name: "厚揚げ", emoji: "🍢", category: "bean", qty: "1/2枚", tags: ["bone", "diet"],
    nutrients: [
  ...
  // --- fruit ---
  { id: "banana", name: "バナナ", emoji: "🍌", category: "fruit", qty: "1本", tags: ["fatigue", "gut"],
    nutrients: [
      { name: "カリウム", effect: "余分な塩分の排出を助け、むくみ対策に役立つとされています。" },
      { name: "ビタミンB群", effect: "糖質からのエネルギー産生を助けます。" },
    ] },
  { id: "apple", name: "りんご", emoji: "🍎", category: "fruit", qty: "1/2個", tags: ["gut", "skin"],
    nutrients: [
      { name: "ペクチン（食物繊維）", effect: "腸内環境を整える水溶性食物繊維です。" },
      { name: "ポリフェノール", effect: "抗酸化作用があるとされています。" },
    ] },
  { id: "strawberry", name: "いちご", emoji: "🍓", category: "fruit", qty: "5粒", tags: ["skin", "immune"],
    nutrients: [
      { name: "ビタミンC", effect: "コラーゲン生成をサポートし、免疫の働きにも関わります。" },
      { name: "食物繊維", effect: "腸内環境を整えます。" },
    ] },
  { id: "kiwi", name: "キウイ", emoji: "🥝", category: "fruit", qty: "1個", tags: ["immune", "gut"],
    nutrients: [
      { name: "ビタミンC", effect: "1個で免疫サポートに役立つ量を摂取しやすい果物です。" },
      { name: "食物繊維・酵素", effect: "消化のサポートに役立つとされています。" },
    ] },
  { id: "orange", name: "オレンジ", emoji: "🍊", category: "fruit", qty: "1個", tags: ["immune", "fatigue"],
    nutrients: [
      { name: "ビタミンC", effect: "免疫の働きと肌の健康をサポートします。" },
      { name: "クエン酸", effect: "疲労回復のサポートに役立つとされる成分です。" },
    ] },
  { id: "blueberry", name: "ブルーベリー", emoji: "🫐", category: "fruit", qty: "大さじ2", tags: ["eye", "skin"],
    nutrients: [
  ...
  // --- dairy ---
  { id: "yogurt", name: "ヨーグルト", emoji: "🥛", category: "dairy", qty: "100g", tags: ["gut", "bone"],
    nutrients: [
      { name: "乳酸菌", effect: "腸内の善玉菌を増やし、腸内フローラのバランスを整える助けになります。" },
      { name: "カルシウム", effect: "骨の健康維持に役立ちます。" },
    ] },
  { id: "milk", name: "牛乳", emoji: "🥛", category: "dairy", qty: "100ml", tags: ["bone"],
    nutrients: [
      { name: "カルシウム", effect: "骨や歯の形成に欠かせないミネラルです。" },
      { name: "良質なたんぱく質", effect: "体づくりの材料になります。" },
    ] },
  { id: "cheese", name: "チーズ", emoji: "🧀", category: "dairy", qty: "1枚", tags: ["bone"],
    nutrients: [
      { name: "カルシウム・たんぱく質", effect: "骨と筋肉の両方の材料を効率よく補給できます。" },
    ] },

  // --- carb ---
  { id: "sweetpotato", name: "さつまいも", emoji: "🍠", category: "carb", qty: "1/2本", tags: ["gut", "skin"],
    nutrients: [
      { name: "食物繊維・ヤラピン", effect: "腸のぜん動運動を促し、便通を助けると言われています。" },
      { name: "ビタミンC", effect: "でんぷんに守られ加熱による損失が少ないのが特徴です。" },
    ] },
  { id: "potato", name: "じゃがいも", emoji: "🥔", category: "carb", qty: "1個", tags: ["immune", "diet"],
    nutrients: [
      { name: "ビタミンC", effect: "加熱に強く、効率よく摂取できます。" },
      { name: "カリウム", effect: "むくみ対策に役立つとされています。" },
    ] },
  { id: "pumpkin", name: "かぼちゃ", emoji: "🎃", category: "carb", qty: "1/8個", tags: ["immune", "skin"],
    nutrients: [
      { name: "β-カロテン", effect: "皮膚や粘膜の健康維持、免疫サポートに役立ちます。" },
      { name: "食物繊維", effect: "腸内環境を整えます。" },
    ] },
  { id: "brownrice", name: "玄米ごはん", emoji: "🍚", category: "carb", qty: "1膳", tags: ["gut", "fatigue"],
    nutrients: [
